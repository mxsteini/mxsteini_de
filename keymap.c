...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_split_3x6_5(KC_ESC, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, RALT(KC_LBRC), LGUI_T(KC_NUHS), KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, LALT_T(KC_QUOT), LCTL_T(KC_RBRC), KC_Z, KC_X, KC_C, KC_V, KC_B, LT(3,KC_SPC), KC_ENT, KC_DEL, LT(3,KC_SPC), KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, RCTL_T(KC_PSLS), TT(4), TT(2), TT(1), KC_LSFT, KC_TAB, KC_BSPC, KC_RSFT, TT(1), TT(2), TT(4)),
